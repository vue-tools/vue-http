...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Vue-http', function () {
	    var spy1 = Spy();
	    var spy2 = Spy();
	    var root = location.protocol + '//' + location.hostname + ':8889';
	    ...
	    it('get', function (done) {
	        ...
	        _vue2.default.http.get('get', { params: params }).then(function (res) {
	    ...
	    it('post', function (done) {
	        ...
	        _vue2.default.http.post('post', params).then(function (res) {
	            expect(res.ok).to.equal(true);
	            expect(res.status).to.equal(200);
	            expect(res.data.foo).to.equal(params.foo);
	            done();
	    ...
	    it('timestamp', function (done) {
	        ...
	        _vue2.default.Promise.all([_vue2.default.http.get('timestamp', { params: params }), _vue2.default.http.post('timestamp', params)]).then(function (res) {
	    ...
	    it('timeout', function (done) {
	        _vue2.default.http.get('timeout');
	        setTimeout(function () {
	    ...
	    it('loading', function (done) {
	        _vue2.default.http.get('loading');
	    ...
	    it('repeat', function (done) {
	        ...
	        _vue2.default.http.get('repeat', { params: params }).then(function (res) {
	            expect(res.ok).to.equal(true);
	            expect(res.status).to.equal(200);
	            expect(res.data.foo).to.equal(params.foo);
	            done();
	        ...
	        _vue2.default.http.get('repeat', { params: params });
	    });

	    it('format data', function (done) {
	        var params = { foo: 'bar' };

	        _vue2.default.http.get('data', { params: params }).then(function (res) {
	    ...
	    it('respone status: 4xx', function (done) {
	        _vue2.default.http.get('4xx');
	    ...
	    it('response status: 5xx', function (done) {
	        _vue2.default.http.get('5xx');
	    ...
	    it('headers', function (done) {
	        _vue2.default.http.get('headers', {
	            headers: {
	                Auth: 'test'
	            }
	        }).then(function (res) {
	...
	function requestRepeatHandler(Vue, opts) {
	    ...
	    Vue.http.interceptors.push(function (req, next) {
	        ...
	        if (req.method.toLowerCase() === 'get') {
	            uid = '' + req.method.toLowerCase() + req.url + (req.params ? (0, _stringify2.default)(req.params) : '');
	        }

	        if (req.method.toLowerCase() === 'post') {
	            uid = '' + req.method.toLowerCase() + req.url + (req.data ? (0, _stringify2.default)(req.data) : '');
	        }
